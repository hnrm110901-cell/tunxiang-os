...
echo ""
echo "  vim /opt/tunxiang-os/services/gateway/.env.production"
echo ""
...
echo "执行以下命令:"
echo ""
echo "  cd /opt/tunxiang-os/services/gateway"
echo ""
echo "  # 6.1 检查当前迁移状态"
...
echo "  docker compose -f infra/compose/base.yml -f infra/compose/envs/prod.yml down"
echo "  docker compose -f infra/compose/base.yml -f infra/compose/envs/prod.yml up -d"
echo ""
echo "  # 8.2 检查服务健康状态"
echo "  docker compose -f infra/compose/base.yml -f infra/compose/envs/prod.yml ps"
