...
export DATABASE_URL="${DATABASE_URL:-postgresql+asyncpg://tunxiang:changeme_dev@localhost/tunxiang_os}"
export JWT_SECRET="${JWT_SECRET:-tunxiang-dev-secret-key-change-in-prod}"
