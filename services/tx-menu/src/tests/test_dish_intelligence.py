...
class TestCalculateDishReputation:
    ...
    def test_excellent_reputation(self):
        inject_dish_reviews("dish-002", TENANT, {
            "total_reviews": 100,
            "positive_count": 95,
            "negative_count": 2,
            "neutral_count": 3,
    ...
    def test_poor_reputation(self):
        inject_dish_reviews("dish-003", TENANT, {
            "total_reviews": 50,
            "positive_count": 10,
            "negative_count": 30,
            "neutral_count": 10,
    ...
    def test_reorder_rate_calculation(self):
        inject_dish_reviews("dish-004", TENANT, {
            "total_reviews": 80,
            "positive_count": 60,
            "negative_count": 5,
            "neutral_count": 15,
...
class TestAutoDeriveStatus:
    ...
    def test_new_dish_within_30_days(self):
        inject_dish_sales("dish-n", TENANT, {
            "total_sales": 50,
    ...
    def test_star_dish(self):
        # 注入多道菜以支撑百分位计算
        for i in range(10):
            inject_dish_sales(f"dish-filler-{i}", TENANT, {
                "total_sales": (i + 1) * 10,
        ...
        # 明星菜：高销高利
        inject_dish_sales("dish-star", TENANT, {
            "total_sales": 500,
    ...
    def test_declining_dish(self):
        inject_dish_sales("dish-dec", TENANT, {
            "total_sales": 100,
    ...
    def test_seasonal_peak(self):
        inject_dish_sales("dish-season", TENANT, {
            "total_sales": 200,
...
class TestGetDishLifecycle:
    ...
    def test_launch_phase(self):
        inject_dish_sales("dish-l", TENANT, {
            "total_sales": 20,
    ...
    def test_mature_phase(self):
        inject_dish_sales("dish-m", TENANT, {
            "total_sales": 1000,
            "recent_week_sales": 50,
    ...
    def test_decline_phase(self):
        inject_dish_sales("dish-d", TENANT, {
            "total_sales": 500,
            "recent_week_sales": 5,
    ...
    def test_weeks_calculation(self):
        inject_dish_sales("dish-w", TENANT, {
            "total_sales": 100,
            "recent_week_sales": 10,
            "previous_week_sales": 10,
...
class TestSuggestDishAction:
    ...
    def test_new_dish_suggest_observe(self):
        inject_dish_sales("dish-new", TENANT, {
            "total_sales": 10,
            "total_revenue_fen": 100000,
            "cost_fen": 1000,
            "price_fen": 3000,
    ...
    def test_declining_suggest_lower_price(self):
        inject_dish_sales("dish-dc", TENANT, {
            "total_sales": 100,
            "total_revenue_fen": 300000,
            "cost_fen": 1500,
            "price_fen": 3000,
    ...
    def test_seasonal_suggest_promote(self):
        inject_dish_sales("dish-sp", TENANT, {
            "total_sales": 200,
            "total_revenue_fen": 600000,
            "cost_fen": 1500,
            "price_fen": 3000,
