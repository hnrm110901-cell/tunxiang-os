...
from sqlalchemy import Boolean, DateTime, Integer, String, Text, Index, ForeignKey
...
class ReferralCampaign(TenantBase):
    ...
    referrer_reward_type: Mapped[str] = mapped_column(
        String(20), nullable=False, default="coupon",
    ...
    referrer_reward_condition: Mapped[str] = mapped_column(
        String(20), nullable=False, default="first_order",
