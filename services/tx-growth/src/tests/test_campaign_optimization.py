...
class TestCampaignOptimizerUnit:
    ...
    def test_two_proportion_z_test_identical_rates(self):
        """相同转化率 → p-value ≈ 1.0"""
        from services.tx_growth.src.services.campaign_optimizer import CampaignOptimizer
...
class TestCampaignOptimizerService:
    ...
    async def test_evaluate_round_not_found(self):
        """无evaluating记录 → 报错"""
        from services.tx_growth.src.services.campaign_optimizer import CampaignOptimizationError, CampaignOptimizer
...
class TestUnifiedSendScheduler:
    ...
    async def test_dedup_blocks_repeat_send(self):
        ...
        from services.tx_growth.src.services.unified_send_scheduler import UnifiedSendScheduler
...
class TestOptimizationWorker:
    ...
    async def test_tick_no_evaluating_records(self):
        ...
        from services.tx_growth.src.workers.optimization_worker import OptimizationWorker
