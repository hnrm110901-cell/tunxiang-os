...
class TestQueueRoutes:
    def test_predict_wait(self):
        resp = client.post(
            "/api/v1/agent/ops/queue/predict-wait",
            json={
                "store_id": "s1",
    ...
    def test_suggest_seating(self):
        resp = client.post(
            "/api/v1/agent/ops/queue/suggest-seating",
            json={
                "store_id": "s1",
    ...
    def test_auto_call(self):
        resp = client.post(
            "/api/v1/agent/ops/queue/auto-call",
            json={
                "store_id": "s1",
...
class TestKitchenRoutes:
    def test_scan_overtime(self):
        resp = client.post(
            "/api/v1/agent/ops/kitchen/scan-overtime",
            json={
                "store_id": "s1",
                "action": "scan",
                "params": {
    ...
    def test_rush(self):
        resp = client.post(
            "/api/v1/agent/ops/kitchen/rush",
            json={
                "store_id": "s1",
                "action": "rush",
                "params": {
                    "item": {"order_no": "O1", "dish_name": "鲈鱼", "table_no": "A01", "kitchen_station": "活鲜档"}
                },
            },
            headers=HEADERS,
        )
    ...
    def test_bottleneck(self):
        resp = client.post(
            "/api/v1/agent/ops/kitchen/bottleneck",
            json={
                "store_id": "s1",
                "action": "bottleneck",
                "params": {
...
class TestBillingRoutes:
    def test_detect_reverse(self):
        resp = client.post(
            "/api/v1/agent/ops/billing/detect-reverse",
            json={
                "store_id": "s1",
                "action": "detect",
                "params": {
                    "operator_id": "c1",
                    "order_id": "o1",
                    "reverse_count_today": 5,
                    "reverse_amount_fen": 80000,
                },
            },
            headers=HEADERS,
        )
    ...
    def test_scan_missing(self):
        resp = client.post(
            "/api/v1/agent/ops/billing/scan-missing",
            json={
                "store_id": "s1",
                "action": "scan",
                "params": {
...
class TestClosingRoutes:
    def test_pre_check(self):
        resp = client.post(
            "/api/v1/agent/ops/closing/pre-check",
            json={
                "store_id": "s1",
                "action": "pre_check",
                "params": {
    ...
    def test_validate_settlement(self):
        resp = client.post(
            "/api/v1/agent/ops/closing/validate-settlement",
            json={
                "store_id": "s1",
                "action": "validate",
                "params": {
                    "total_revenue_fen": 100000,
                    "payment_sum_fen": 100000,
                    "refund_total_fen": 0,
                    "order_count": 10,
                    "channel_order_sum": 10,
                },
            },
            headers=HEADERS,
        )
