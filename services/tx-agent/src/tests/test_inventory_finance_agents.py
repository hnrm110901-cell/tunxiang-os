...
class TestRevenueAnomaly:
    def test_normal_revenue(self):
        ...
        result = asyncio.run(agent.execute("detect_revenue_anomaly", {
...
class TestForecastOrders:
    def test_basic_forecast(self):
        agent = FinanceAuditAgent(tenant_id=TID)
        result = asyncio.run(agent.execute("forecast_orders", {
...
class TestOrderTrend:
    def test_upward_trend(self):
        agent = FinanceAuditAgent(tenant_id=TID)
        result = asyncio.run(agent.execute("analyze_order_trend", {
