...
class IntelReporterAgent(SkillAgent):
    ...
    async def _competitor_weekly(self, params: dict) -> AgentResult:
        ...
        return AgentResult(
            success=True, action="generate_competitor_weekly",
            data={
                "week": week,
                "title": f"竞对动态周报 — {week}",
                "sections": sections,
    ...
    async def _demand_weekly(self, params: dict) -> AgentResult:
        ...
        sections = [
            {
                ...
                "rising": [{"keyword": r.get("keyword"), "growth_pct": r.get("growth_pct")} for r in rising_demands[:5]],
                "falling": [{"keyword": f.get("keyword"), "decline_pct": f.get("decline_pct")} for f in falling_demands[:5]],
            },
            {
                "title": "二、顾客评论趋势",
        ...
        return AgentResult(
            success=True, action="generate_demand_weekly",
            data={
                "week": week,
                "title": f"需求变化周报 — {week}",
                "sections": sections,
    ...
    async def _product_weekly(self, params: dict) -> AgentResult:
        ...
        return AgentResult(
            success=True, action="generate_product_weekly",
            data={
                "week": week,
                "title": f"新品趋势周报 — {week}",
                "sections": sections,
    ...
    async def _ingredient_weekly(self, params: dict) -> AgentResult:
        ...
        return AgentResult(
            success=True, action="generate_ingredient_weekly",
            data={
                "week": week,
                "title": f"原料趋势周报 — {week}",
                "sections": sections,
    ...
    async def _district_weekly(self, params: dict) -> AgentResult:
        ...
        return AgentResult(
            success=True, action="generate_district_weekly",
            data={
                "week": week,
                "title": f"商圈情报周报 — {week}",
    ...
    async def _monthly_report(self, params: dict) -> AgentResult:
        ...
        return AgentResult(
            success=True, action="generate_monthly_report",
    ...
    async def _custom_report(self, params: dict) -> AgentResult:
        ...
        return AgentResult(
            success=True, action="generate_custom_report",
            data={"report": report},
