...
_register(
    "discount_guard__scan_store_licenses",
    _entry(
        agent_id="discount_guard",
...
_register(
    "discount_guard__scan_all_licenses",
    _entry(
        agent_id="discount_guard",
...
_register(
    "discount_guard__get_financial_report",
    _entry(
        agent_id="discount_guard",
...
_register(
    "discount_guard__explain_voucher",
    _entry(
        agent_id="discount_guard",
...
_register(
    "discount_guard__reconciliation_status",
    _entry(
        agent_id="discount_guard",
...
_register(
    "smart_menu__recommend_pilot_stores",
    _entry(
        agent_id="smart_menu",
...
_register(
    "smart_menu__check_launch_readiness",
    _entry(
        agent_id="smart_menu",
...
_register(
    "smart_menu__inspect_dish_quality",
    _entry(
        agent_id="smart_menu",
...
_register(
    "serve_dispatch__predict_serve_time",
    _entry(
...
_register(
    "serve_dispatch__optimize_schedule",
    _entry(
        agent_id="serve_dispatch",
...
_register(
    "serve_dispatch__analyze_traffic",
    _entry(
        agent_id="serve_dispatch",
...
_register(
    "serve_dispatch__predict_staffing_needs",
    _entry(
        agent_id="serve_dispatch",
...
_register(
    "serve_dispatch__detect_order_anomaly",
    _entry(
        agent_id="serve_dispatch",
...
_register(
    "serve_dispatch__trigger_chain_alert",
    _entry(
        agent_id="serve_dispatch",
...
_register(
    "serve_dispatch__balance_workload",
    _entry(
        agent_id="serve_dispatch",
...
_register(
    "member_insight__detect_signals",
    _entry(
        agent_id="member_insight",
...
_register(
    "member_insight__detect_competitor",
    _entry(
        agent_id="member_insight",
...
_register(
    "member_insight__trigger_journey",
    _entry(
        agent_id="member_insight",
...
_register(
    "member_insight__get_churn_risks",
    _entry(
        agent_id="member_insight",
...
_register(
    "member_insight__process_bad_review",
    _entry(
        agent_id="member_insight",
...
_register(
    "member_insight__monitor_service_quality",
    _entry(
        agent_id="member_insight",
...
_register(
    "member_insight__handle_complaint",
    _entry(
        agent_id="member_insight",
...
_register(
    "member_insight__collect_feedback",
    _entry(
        agent_id="member_insight",
...
_register(
    "inventory_alert__monitor_inventory",
    _entry(
...
_register(
    "inventory_alert__predict_consumption",
    _entry(
        agent_id="inventory_alert",
...
_register(
    "inventory_alert__generate_restock_alerts",
    _entry(
        agent_id="inventory_alert",
...
_register(
    "inventory_alert__check_expiration",
    _entry(
        agent_id="inventory_alert",
...
_register(
    "inventory_alert__optimize_stock_levels",
    _entry(
        agent_id="inventory_alert",
...
_register(
    "inventory_alert__compare_supplier_prices",
    _entry(
        agent_id="inventory_alert",
...
_register(
    "inventory_alert__evaluate_supplier",
    _entry(
        agent_id="inventory_alert",
...
_register(
    "inventory_alert__scan_contract_risks",
    _entry(
        agent_id="inventory_alert",
...
_register(
    "inventory_alert__analyze_waste",
    _entry(
        agent_id="inventory_alert",
...
_register(
    "finance_audit__get_financial_report",
    _entry(
...
_register(
    "finance_audit__detect_revenue_anomaly",
    _entry(
        agent_id="finance_audit",
...
_register(
    "finance_audit__forecast_orders",
    _entry(
        agent_id="finance_audit",
...
_register(
    "finance_audit__generate_biz_insight",
    _entry(
        agent_id="finance_audit",
...
_register(
    "finance_audit__analyze_order_trend",
    _entry(
        agent_id="finance_audit",
...
_register(
    "store_inspect__suggest_runbook",
    _entry(
        agent_id="store_inspect",
...
_register(
    "store_inspect__predict_maintenance",
    _entry(
        agent_id="store_inspect",
...
_register(
    "store_inspect__security_advice",
    _entry(
        agent_id="store_inspect",
...
_register(
    "store_inspect__food_safety_status",
    _entry(
        agent_id="store_inspect",
...
_register(
    "store_inspect__store_dashboard",
    _entry(
        agent_id="store_inspect",
...
_register(
    "smart_service__analyze_feedback",
    _entry(
...
_register(
    "smart_service__handle_complaint",
    _entry(
        agent_id="smart_service",
        action="handle_complaint",
...
_register(
    "smart_service__generate_improvements",
    _entry(
        agent_id="smart_service",
...
_register(
    "smart_service__assess_training_needs",
    _entry(
        agent_id="smart_service",
...
_register(
    "smart_service__generate_training_plan",
    _entry(
        agent_id="smart_service",
...
_register(
    "smart_service__track_training_progress",
    _entry(
        agent_id="smart_service",
...
_register(
    "smart_service__evaluate_effectiveness",
    _entry(
        agent_id="smart_service",
...
_register(
    "smart_service__analyze_skill_gaps",
    _entry(
        agent_id="smart_service",
...
_register(
    "smart_service__manage_certificates",
    _entry(
        agent_id="smart_service",
...
_register(
    "private_ops__get_private_domain_dashboard",
    _entry(
...
_register(
    "private_ops__score_performance",
    _entry(
        agent_id="private_ops",
...
_register(
    "private_ops__analyze_labor_cost",
    _entry(
        agent_id="private_ops",
...
_register(
    "private_ops__create_reservation",
    _entry(
        agent_id="private_ops",
...
_register(
    "event_bus__get_all_event_types",
    _entry(
        agent_id="event_bus",
...
_register(
    "member_insight__analyze_member",
    _entry(
        agent_id="member_insight",
        action="analyze",
...
_register(
    "patrol_inspector__analyze_from_mv",
    _entry(
        agent_id="patrol_inspector",
...
_register(
    "patrol_inspector__get_opinion_context",
    _entry(
        agent_id="patrol_inspector",
...
_register(
    "crm_operator__generate_campaign",
    _entry(
...
_register(
    "customer_service__analyze_from_mv",
    _entry(
        agent_id="customer_service",
        action="analyze_from_mv",
...
_register(
    "energy_monitor__analyze_from_mv",
    _entry(
        agent_id="energy_monitor",
        action="analyze_from_mv",
...
_register(
    "payment_nexus__list_pending_agent_payments",
    _entry(
        agent_id="payment_nexus",
...
def get_skill_agent_tool_count() -> int:
    ...
    return sum(1 for entry in TOOL_REGISTRY.values() if entry["agent_id"] not in ("master", "planner", "event_bus"))


def get_tools_by_agent(agent_id: str) -> dict[str, ToolEntry]:
    """Return all tools belonging to a specific agent."""
    return {name: entry for name, entry in TOOL_REGISTRY.items() if entry["agent_id"] == agent_id}
