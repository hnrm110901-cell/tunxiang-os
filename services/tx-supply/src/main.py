...
from .api.yield_standard_routes import router as yield_standard_router
...
from .api.requisition_template_routes import router as requisition_template_router
from .api.dept_whitelist_routes import router as dept_whitelist_router
from .api.market_survey_routes import (
    ingredients_router as market_survey_ingredients_router,
    router as market_survey_router,
)
...
app.include_router(requisition_template_router)  # 申购模板 (PRD-07 / Phase 2 W10 / T2 + #589 闭环)
