...
SALARY_ITEMS: Dict[str, List[SalaryItem]] = {
    ...
    "attendance": [
        ...
        SalaryItem("ATT_006", "日薪", "attendance", "other", "formula", "base_salary_fen / 21.75", False, 0, "月薪按法定计薪日折算日薪"),
        SalaryItem("ATT_007", "时薪", "attendance", "other", "formula", "base_salary_fen / 21.75 / 8", False, 0, "月薪按法定计薪日折算时薪"),
        SalaryItem("ATT_008", "计件工资", "attendance", "pre_tax_add", "formula", "piece_count * piece_rate_fen", False, 0, "按件计薪（适用后厨切配等岗位）"),
        SalaryItem("ATT_009", "职级工资", "attendance", "pre_tax_add", "fixed", "", False, 0, "按职级体系确定的固定补充工资"),
        SalaryItem("ATT_010", "试用期工资", "attendance", "pre_tax_add", "formula", "base_salary_fen * 0.8", False, 0, "试用期按基本工资80%发放"),
        ...
        SalaryItem("ATT_013", "兼职日薪", "attendance", "pre_tax_add", "formula", "parttime_days * parttime_daily_fen", False, 0, "兼职人员按天计薪"),
        SalaryItem("ATT_014", "小时工时薪", "attendance", "pre_tax_add", "formula", "hourly_rate_fen * work_hours", False, 0, "小时工按实际工时计算"),
        SalaryItem("ATT_015", "调休折算", "attendance", "pre_tax_sub", "formula", "comp_off_days * daily_rate_fen", False, 0, "调休天数折算扣款"),
    ],

    # ── 假期类（10项） ──
    "leave": [
        SalaryItem("LV_001", "年假工资", "leave", "pre_tax_add", "formula", "annual_leave_days * daily_rate_fen", False, 0, "带薪年假工资（按日薪计）"),
        SalaryItem("LV_002", "病假工资", "leave", "pre_tax_add", "formula", "sick_leave_days * daily_rate_fen * 0.6", False, 0, "病假按日薪60%发放"),
        SalaryItem("LV_003", "事假扣款", "leave", "pre_tax_sub", "formula", "personal_leave_days * daily_rate_fen", False, 0, "事假按日薪全额扣除"),
        SalaryItem("LV_004", "产假工资", "leave", "pre_tax_add", "formula", "maternity_leave_days * daily_rate_fen", False, 0, "产假期间全薪发放"),
        SalaryItem("LV_005", "陪产假工资", "leave", "pre_tax_add", "formula", "paternity_leave_days * daily_rate_fen", False, 0, "陪产假期间全薪发放"),
        SalaryItem("LV_006", "婚丧假工资", "leave", "pre_tax_add", "formula", "marriage_funeral_days * daily_rate_fen", False, 0, "婚假/丧假期间全薪发放"),
        SalaryItem("LV_007", "工伤假工资", "leave", "pre_tax_add", "formula", "injury_leave_days * daily_rate_fen", False, 0, "工伤假期间全薪发放"),
        SalaryItem("LV_008", "哺乳假工资", "leave", "pre_tax_add", "formula", "nursing_leave_days * daily_rate_fen", False, 0, "哺乳假期间工资"),
        SalaryItem("LV_009", "育儿假工资", "leave", "pre_tax_add", "formula", "childcare_leave_days * daily_rate_fen", False, 0, "育儿假期间全薪发放"),
        SalaryItem("LV_010", "护理假工资", "leave", "pre_tax_add", "formula", "care_leave_days * daily_rate_fen", False, 0, "护理假期间全薪发放"),
    ],

    # ── 绩效类（12项） ──
    "performance": [
        SalaryItem("PERF_001", "KPI奖金", "performance", "pre_tax_add", "formula", "base_salary_fen * max(0, perf_coefficient - 100) / 100", False, 0, "KPI考核系数超过100部分对应奖金"),
        ...
        SalaryItem("PERF_005", "超额完成奖", "performance", "pre_tax_add", "formula", "exceed_amount_fen * exceed_bonus_rate", False, 0, "超额完成业绩目标奖励"),
        SalaryItem("PERF_006", "团队协作奖", "performance", "pre_tax_add", "manual", "", False, 0, "团队协作表现突出奖金"),
        SalaryItem("PERF_007", "创新建议奖", "performance", "pre_tax_add", "manual", "", False, 0, "提出创新建议被采纳奖励"),
        ...
        SalaryItem("PERF_010", "全勤奖", "performance", "pre_tax_add", "fixed", "", False, 30000, "当月无缺勤/迟到/早退发放，默认300元"),
        SalaryItem("PERF_011", "优秀员工奖", "performance", "pre_tax_add", "manual", "", False, 0, "月度/季度优秀员工评选奖金"),
        SalaryItem("PERF_012", "师带徒奖金", "performance", "pre_tax_add", "manual", "", False, 0, "新员工带教导师额外奖励"),
    ],

    # ── 提成类（10项） ──
    "commission": [
        SalaryItem("COMM_001", "营业额提成", "commission", "pre_tax_add", "formula", "sales_amount_fen * commission_rate", False, 0, "按门店/个人营业额比例提成"),
        SalaryItem("COMM_002", "翻台率提成", "commission", "pre_tax_add", "formula", "turnover_bonus_per_table_fen * extra_turnover_count", False, 0, "翻台率超标部分每桌奖励"),
        SalaryItem("COMM_003", "推菜提成", "commission", "pre_tax_add", "formula", "recommended_dish_amount_fen * recommend_rate", False, 0, "主推菜品销售提成"),
        SalaryItem("COMM_004", "酒水提成", "commission", "pre_tax_add", "formula", "beverage_amount_fen * beverage_comm_rate", False, 0, "酒水饮料销售提成"),
        SalaryItem("COMM_005", "加单提成", "commission", "pre_tax_add", "formula", "upsell_amount_fen * upsell_rate", False, 0, "客户加单金额提成"),
        SalaryItem("COMM_006", "会员开卡提成", "commission", "pre_tax_add", "formula", "new_member_count * member_card_bonus_fen", False, 0, "每成功开卡一位会员的奖励"),
        SalaryItem("COMM_007", "储值提成", "commission", "pre_tax_add", "formula", "stored_value_fen * stored_value_rate", False, 0, "会员储值金额提成"),
        SalaryItem("COMM_008", "外卖提成", "commission", "pre_tax_add", "formula", "delivery_amount_fen * delivery_comm_rate", False, 0, "外卖订单金额提成"),
        SalaryItem("COMM_009", "团购核销提成", "commission", "pre_tax_add", "formula", "groupon_verify_count * groupon_bonus_fen", False, 0, "每核销一张团购券奖励"),
        SalaryItem("COMM_010", "宴席提成", "commission", "pre_tax_add", "formula", "banquet_amount_fen * banquet_comm_rate", False, 0, "宴席订单金额提成"),
    ],

    # ── 补贴类（10项） ──
    "subsidy": [
        SalaryItem("SUB_001", "工龄补贴", "subsidy", "pre_tax_add", "formula", "seniority_subsidy(seniority_months)", False, 0, "按工龄阶梯发放，满1年起"),
        ...
        SalaryItem("SUB_004", "住房补贴", "subsidy", "pre_tax_add", "fixed", "", False, 50000, "未住员工宿舍的住宿补贴，默认500元/月"),
        SalaryItem("SUB_005", "高温补贴", "subsidy", "pre_tax_add", "fixed", "", False, 30000, "6-9月高温补贴（厨师等高温岗位），默认300元/月"),
        SalaryItem("SUB_006", "夜班补贴", "subsidy", "pre_tax_add", "formula", "night_shift_days * night_shift_rate_fen", False, 0, "夜班天数 x 每日夜班补贴"),
        SalaryItem("SUB_007", "技能补贴", "subsidy", "pre_tax_add", "fixed", "", False, 0, "持证上岗技能补贴（厨师证/食品安全证等）"),
        SalaryItem("SUB_008", "学历补贴", "subsidy", "pre_tax_add", "fixed", "", False, 0, "大专/本科/硕士等学历补贴"),
        SalaryItem("SUB_009", "通讯补贴", "subsidy", "pre_tax_add", "fixed", "", False, 10000, "手机通讯补贴，默认100元/月"),
        SalaryItem("SUB_010", "出差补贴", "subsidy", "pre_tax_add", "formula", "business_trip_days * trip_daily_fen", False, 0, "出差期间每日补贴"),
    ],
    ...
    "deduction": [
        ...
        SalaryItem("DED_004", "事假扣款", "deduction", "pre_tax_sub", "formula", "base_salary_fen / work_days_in_month * personal_leave_days", False, 0, "事假按日薪扣除"),
        SalaryItem("DED_005", "违规罚款", "deduction", "pre_tax_sub", "manual", "", False, 0, "违反公司规章制度处罚"),
        SalaryItem("DED_006", "赔偿扣款", "deduction", "pre_tax_sub", "manual", "", False, 0, "餐具/设备损坏等赔偿扣款"),
    ...
    "social": [
        ...
        SalaryItem("SOC_004", "住房公积金(个人)", "social", "pre_tax_sub", "formula", "housing_fund_base_fen * housing_fund_rate", False, 0, "住房公积金个人缴纳（5%-12%）"),
        SalaryItem("SOC_005", "补充医疗(个人)", "social", "pre_tax_sub", "fixed", "", False, 0, "补充医疗保险个人部分"),
        SalaryItem("SOC_006", "企业年金(个人)", "social", "pre_tax_sub", "formula", "social_base_fen * annuity_rate", False, 0, "企业年金个人缴纳部分"),
    ],
}
...
STORE_TEMPLATES: Dict[str, Dict[str, Any]] = {
    "standard": {
        ...
        "enabled_items": [
            # 出勤
            "ATT_001", "ATT_002", "ATT_003", "ATT_004", "ATT_005",
            # 假期
            "LV_001", "LV_002", "LV_003",
            # 绩效
            "PERF_001", "PERF_002", "PERF_010",
            # 提成
            "COMM_001", "COMM_003", "COMM_004", "COMM_006",
            # 补贴
            "SUB_001", "SUB_002", "SUB_003", "SUB_006",
            # 扣款
    ...
    "seafood": {
        ...
        "enabled_items": [
            # 出勤
            "ATT_001", "ATT_002", "ATT_003", "ATT_004", "ATT_005", "ATT_009",
            # 假期
            "LV_001", "LV_002", "LV_003", "LV_004", "LV_005", "LV_006",
            # 绩效
            "PERF_001", "PERF_002", "PERF_003", "PERF_004", "PERF_005",
            "PERF_010", "PERF_011",
            # 提成
            "COMM_001", "COMM_002", "COMM_003", "COMM_004", "COMM_005",
            "COMM_006", "COMM_007", "COMM_010",
            # 补贴
            "SUB_001", "SUB_002", "SUB_003", "SUB_004", "SUB_005",
            "SUB_006", "SUB_007", "SUB_009",
            # 扣款
            "DED_001", "DED_002", "DED_003", "DED_005", "DED_006", "DED_007",
            # 社保
            "SOC_001", "SOC_002", "SOC_003", "SOC_004", "SOC_005",
        ],
        "default_overrides": {
    ...
    "fast_food": {
        ...
        "enabled_items": [
            # 出勤
            "ATT_001", "ATT_003", "ATT_004", "ATT_005", "ATT_014",
            # 假期
            "LV_001", "LV_002", "LV_003",
            # 绩效
            "PERF_001", "PERF_002", "PERF_010",
            ...
            "COMM_001", "COMM_008",
            # 补贴
            "SUB_002", "SUB_003", "SUB_001",
            # 扣款
            "DED_001", "DED_002", "DED_003", "DED_007",
            # 社保
            "SOC_001", "SOC_002", "SOC_003",
        ],
        "default_overrides": {
