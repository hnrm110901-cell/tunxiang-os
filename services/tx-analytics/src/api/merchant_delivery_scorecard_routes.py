...
_BASELINES: dict[str, dict[str, Any]] = {
    "czyz": {
        ...
        "details": {
            "func_completeness": {
                "收银/桌台/KDS": 100, "菜单管理": 95, "会员 CDP": 90,
                "库存预警": 85, "经营分析驾驶舱": 85, "Agent OS": 75,
                "日清日结 E1-E8": 70, "供应链采购": 65,
            },
            "data_quality": {
                "门店数据完整率": 95, "菜品数据完整率": 90, "会员数据完整率": 85,
                "历史订单数据": 75, "KPI权重配置": 90, "桌台数据": 90,
            },
            "performance": {
                "P99 响应时间": "< 800ms", "健康检查": "全绿",
                "并发 50 用户稳定": True,
            },
            "demo_readiness": {
                "演示导播手册": True, "种子数据已加载": True,
                "备用话术准备": True, "紧急回退脚本": True,
            },
        },
    },
    "zqx": {
        ...
        "details": {
            "func_completeness": {
                "收银/桌台/KDS": 100, "菜单管理": 90, "会员 CDP": 90,
                "私域运营": 80, "经营分析驾驶舱": 80, "Agent OS": 70,
                "复购驱动营销": 75, "供应链采购": 60,
            },
            "data_quality": {
                "门店数据完整率": 90, "菜品数据完整率": 85, "会员数据完整率": 80,
                "历史订单数据": 70, "KPI权重配置": 90, "桌台数据": 85,
            },
            "performance": {
                "P99 响应时间": "< 900ms", "健康检查": "全绿",
                "并发 50 用户稳定": True,
            },
            "demo_readiness": {
                "演示导播手册": True, "种子数据已加载": True,
    ...
    "sgc": {
        ...
        "details": {
            "func_completeness": {
                "收银/桌台/KDS": 100, "菜单管理": 85, "宴会管理": 75,
                "会员 CDP": 75, "经营分析驾驶舱": 75, "Agent OS": 65,
                "供应链采购": 60, "财务结算": 60,
            },
            "data_quality": {
                "门店数据完整率": 85, "菜品数据完整率": 75, "会员数据完整率": 70,
                "历史订单数据": 65, "KPI权重配置": 85, "桌台数据": 80,
            },
            "performance": {
                "P99 响应时间": "< 1000ms", "健康检查": "全绿",
                "并发 50 用户稳定": True,
            },
            "demo_readiness": {
                "演示导播手册": True, "种子数据已加载": True,
                "备用话术准备": True, "紧急回退脚本": False,
            },
        },
    },
}
...
def _compute_score(code: str) -> dict[str, Any]:
    ...
    return {
        ...
        "dimensions": {
            "func_completeness": {
                "raw": b["func_completeness"], "weight": 0.40, "weighted": func_score,
            },
            "data_quality": {
                "raw": b["data_quality"], "weight": 0.25, "weighted": data_score,
            },
            "performance": {
                "raw": b["performance"], "weight": 0.15, "weighted": perf_score,
            },
            "demo_readiness": {
                "raw": b["demo_readiness"], "weight": 0.20, "weighted": demo_score,
            },
        },
        "details": b["details"],
