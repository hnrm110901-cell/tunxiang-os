...
2. POST   /api/v1/retail/products                 创建商品（后台）
3. PUT    /api/v1/retail/products/{id}            更新商品
4. PUT    /api/v1/retail/products/{id}/status     商品上下架（后台）
5. POST   /api/v1/retail/orders                   创建零售订单
6. GET    /api/v1/retail/orders/{id}              订单详情
