...
_ELEMENTS_CATALOG = [
    ...
    },
    {
        ...
        "category": "布局",
        "props": [
            {"key": "char", "label": "分隔符", "type": "select", "options": ["-", "=", "*"], "default": "-"},
        ],
    },
    {
        "type": "order_info",
    ...
    },
    {
        ...
        "props": [
            ...
            {"key": "show_service_fee", "label": "显示服务费", "type": "boolean", "default": True},
        ],
    },
    {
        "type": "payment_method",
        ...
        "props": [
            {
                ...
                "label": "内容字段",
                "type": "select",
                "options": ["order_id", "order_no", "store_id"],
                "default": "order_id",
            },
            {"key": "content", "label": "固定内容（留空则取字段）", "type": "text", "default": ""},
    ...
    },
    {
        ...
        "category": "自定义",
        "props": [
            {"key": "content", "label": "文字内容（支持 {{变量}}）", "type": "text", "default": "谢谢惠顾，欢迎再来！"},
            {
                "key": "align",
                "label": "对齐",
                "type": "select",
    ...
    },
    {
        ...
        "category": "自定义",
        "props": [
            {"key": "content", "label": "文字内容", "type": "text", "default": "屯象OS · 智慧餐饮"},
            {
                "key": "align",
                "label": "对齐",
                "type": "select",
    ...
    },
    {
        ...
        "category": "美化增强",
        "props": [
            {"key": "content", "label": "文字内容（支持 {{变量}}）", "type": "text", "default": "{{store_name}}"},
            {
                "key": "align",
                "label": "对齐",
                "type": "select",
    ...
    },
    {
        ...
        "category": "多媒体",
        "props": [
            {"key": "image_base64", "label": "图片（Base64 PNG/JPEG）", "type": "image_upload", "default": ""},
            {"key": "align", "label": "对齐", "type": "select", "options": ["left", "center"], "default": "center"},
            {"key": "max_width_dots", "label": "最大点宽（80mm纸=384，58mm=288）", "type": "number", "default": 384},
        ],
    },
    {
        ...
        "category": "美化增强",
        "props": [
            {"key": "content", "label": "文字内容（支持 {{变量}}）", "type": "text", "default": "扫码评价享优惠"},
            {
                "key": "align",
                "label": "对齐",
                "type": "select",
        ...
        "config": {
            ...
            "elements": [
                ...
                },
                {
                    ...
                    "type": "box_section",
                    "style": "double",
                    "lines": ["感谢您选择{{store_name}}", "您的满意是我们最大的动力"],
                    "align": "center",
                },
...
def _preview_lines_from_config(
    ...
    for elem in config.elements:
        ...
        if etype == "store_name":
            ...
            label_map = {"table_no": "桌号", "order_no": "单号", "cashier": "收银", "datetime": "时间"}
            ...
            show_service_fee = elem.show_service_fee if elem.show_service_fee is not None else True
            lines.append(
                {
                    "type": "text",
...
async def update_template(
    ...
    if req.config is not None:
        ...
        params["config"] = __import__("json").dumps(req.config.model_dump(), ensure_ascii=False)
