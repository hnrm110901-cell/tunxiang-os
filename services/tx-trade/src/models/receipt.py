...
class ReceiptTemplate(TenantBase):
    ...
    print_type: Mapped[str] = mapped_column(String(20), nullable=False, default=PrintType.receipt.value)
...
class ReceiptLog(TenantBase):
    ...
    printed_at: Mapped[str] = mapped_column(DateTime(timezone=True), server_default=func.now())
