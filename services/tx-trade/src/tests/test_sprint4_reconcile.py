...
def _build_pos_payments_10_records():
    ...
    return [
        # 前8条正常匹配
        {
            "payment_no": "PAY20260326120100A1",
            "trade_no": "WX20260326120100001",
            "amount_fen": 5800,
            "fee_fen": 35,
            "method": "wechat",
            "order_no": "TX20260326001",
        },
        {
            "payment_no": "PAY20260326121500A2",
            "trade_no": "WX20260326121500002",
            "amount_fen": 12800,
            "fee_fen": 77,
            "method": "wechat",
            "order_no": "TX20260326002",
        },
        {
            "payment_no": "PAY20260326123000A3",
            "trade_no": "WX20260326123000003",
            "amount_fen": 8850,
            "fee_fen": 53,
            "method": "wechat",
            "order_no": "TX20260326003",
        },
        {
            "payment_no": "PAY20260326130000A4",
            "trade_no": "WX20260326130000004",
            "amount_fen": 25600,
            "fee_fen": 154,
            "method": "wechat",
            "order_no": "TX20260326004",
        },
        {
            "payment_no": "PAY20260326132000A5",
            "trade_no": "WX20260326132000005",
            "amount_fen": 4200,
            "fee_fen": 25,
            "method": "wechat",
            "order_no": "TX20260326005",
        },
        {
            "payment_no": "PAY20260326140000A6",
            "trade_no": "WX20260326140000006",
            "amount_fen": 19800,
            "fee_fen": 119,
            "method": "wechat",
            "order_no": "TX20260326006",
        },
        {
            "payment_no": "PAY20260326143000A7",
            "trade_no": "WX20260326143000007",
            "amount_fen": 7500,
            "fee_fen": 45,
            "method": "wechat",
            "order_no": "TX20260326007",
        },
        {
            "payment_no": "PAY20260326150000A8",
            "trade_no": "WX20260326150000008",
            "amount_fen": 32000,
            "fee_fen": 192,
            "method": "wechat",
            "order_no": "TX20260326008",
        },
        # 第9条：POS金额 16800 vs 渠道 16600 → amount_mismatch (差200分=2元)
        {
            "payment_no": "PAY20260326153000A9",
            "trade_no": "WX20260326153000009",
            "amount_fen": 16800,
            "fee_fen": 100,
            "method": "wechat",
            "order_no": "TX20260326009",
        },
        # 第10条：POS金额 9200 vs 渠道 8900 → amount_mismatch (差300分=3元)
        {
            "payment_no": "PAY20260326160000AA",
            "trade_no": "WX20260326160000010",
            "amount_fen": 9200,
            "fee_fen": 53,
            "method": "wechat",
            "order_no": "TX20260326010",
        },
    ]
...
class TestLayer2TriReconciliation:
    ...
    def test_tri_reconciliation_partial_and_no_match(self):
        ...
        bank_entries = [
            {"entry_id": "BANK001", "amount_fen": 10000, "description": "入账", "counterparty": "微信支付"},
        ]
...
class TestDeliveryOrderLifecycle:
    ...
    def _build_menu_items(self):
        return [
            ...
            {"dish_id": "D003", "name": "米饭", "price_fen": 200, "category": "主食", "stock": 999, "sku_id": "SKU_MF"},
            {
                "dish_id": "D004",
                "name": "蒜蓉西兰花",
                "price_fen": 2800,
...
class TestMenuSync:
    ...
    def test_sync_menu_to_meituan(self):
        """同步菜单到美团"""
        menu_items = [
            {"dish_id": "D001", "name": "酸菜鱼（大份）", "price_fen": 6800, "category": "招牌菜", "stock": 50},
            {"dish_id": "D002", "name": "水煮牛肉", "price_fen": 5800, "category": "热菜", "stock": 30},
            {"dish_id": "D003", "name": "米饭", "price_fen": 200, "category": "主食", "stock": 999},
            {"dish_id": "D004", "name": "可乐", "price_fen": 500, "category": "饮品", "stock": 100},
        ]
