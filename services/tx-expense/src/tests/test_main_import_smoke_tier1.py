"""Tier 1 — tx-expense main.py 容器布局 import 烟测 (issue #714 W22 补全 PR #351 漏 5 服务)。

Dockerfile CMD: ``uvicorn services.tx_expense.src.main:app`` (mode A 标准布局).
"""
...
def test_main_module_loads_in_container_layout() -> None:
    """tx_expense main.py 必须在 Docker 容器布局下干净 import."""
