...
_AUDIT_LOGS: list[AuditLogSchema] = [
    AuditLogSchema(
        id="1",
        timestamp="2026-04-02 10:23:45",
        user_name="李淳",
        user_id="u001",
        action="update",
        resource_type="dish",
        resource_id="dish-001",
    ...
    AuditLogSchema(
        ...
        old_data=None,
        new_data={"name": "王先生", "level": "gold"},
        description="新建会员",
    ),
    AuditLogSchema(
        id="3",
        timestamp="2026-04-02 09:55:12",
        user_name="刘店长",
        user_id="u003",
        action="delete",
        resource_type="order",
        ...
        old_data={"order_no": "TX20260402001", "total": 288},
        new_data=None,
        description="删除已取消订单",
    ),
    AuditLogSchema(
    ...
    AuditLogSchema(
        id="5",
        timestamp="2026-04-02 09:00:05",
        user_name="张管理",
        user_id="u002",
        action="export",
        resource_type="order",
        resource_id="batch-0402",
        ip_address="192.168.1.101",
        old_data=None,
        new_data={"format": "csv", "count": 1523},
        description="导出订单数据",
    ),
    AuditLogSchema(
        id="6",
        timestamp="2026-04-01 18:45:22",
        user_name="王总监",
        user_id="u004",
        action="approve",
...
async def list_dictionaries(
    ...
    if keyword:
        results = [d for d in results if keyword in d.name or keyword in d.code or keyword in d.description]
