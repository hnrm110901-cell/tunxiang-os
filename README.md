...
L2  业务中台       16 个微服务 × 8 大产品域 = 211+ API 模块
...
│   ├── db-migrations/               # Alembic 增量迁移（113 个版本，v001-v104）
...
| iPad（可选升级） | iPad Air/Pro | 高端店 POS/KDS | **无**（外设指令 WiFi 转安卓）|

**铁律**：安卓做"碰硬件的脏活"，Mac mini 做"需要算力的智能活"。
...
| 9 | RLS 安全漏洞 → 修复+加固 | ✅ 已修复（v063） | Phase 0 |
