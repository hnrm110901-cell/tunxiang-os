...
**详细设计**（终端映射、数据流、AI 分层、工程路径）：[`docs/architecture-store-terminals-stable-ai.md`](docs/architecture-store-terminals-stable-ai.md) · 分阶段落地参见 [`docs/development-plan-mixed-terminals-claude-2026Q2.md`](docs/development-plan-mixed-terminals-claude-2026Q2.md)
