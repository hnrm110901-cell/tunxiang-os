...
def upgrade() -> None:
    ...
    if "franchisees" not in _existing:
        op.create_table(
            ...
            sa.Column("legal_name", sa.String(200), nullable=False, comment="工商注册名称"),
            sa.Column("brand_name", sa.String(100), nullable=True, comment="品牌/门店简称"),
            ...
            sa.Column("business_license_no", sa.String(50), nullable=True, comment="营业执照编号"),
            sa.Column("legal_person_name", sa.String(50), nullable=True, comment="法定代表人姓名"),
            sa.Column(
                "status",
                sa.String(20),
                nullable=False,
    ...
    if "franchise_royalty_rules" not in _existing:
        op.create_table(
            ...
            sa.Column("effective_to", sa.Date, nullable=True, comment="NULL 表示长期有效"),
    ...
    if "franchise_royalty_bills" not in _existing:
        op.create_table(
            ...
            sa.Column("revenue_fen", sa.Integer, nullable=False, server_default="0", comment="当期营业额（分）"),
            sa.Column(
                "royalty_rate_applied",
                sa.Numeric(6, 4),
                nullable=False,
                server_default="0",
                comment="实际应用的分润比率快照",
            ),
            sa.Column("royalty_amount_fen", sa.Integer, nullable=False, server_default="0", comment="分润金额（分）"),
            sa.Column(
                "initial_fee_fen",
                sa.Integer,
                nullable=False,
            ...
            sa.Column("other_fee_fen", sa.Integer, nullable=False, server_default="0", comment="其他杂项费用（分）"),
            sa.Column("total_due_fen", sa.Integer, nullable=False, server_default="0", comment="本期应付合计（分）"),
            sa.Column(
                "status",
                sa.String(20),
                nullable=False,
    ...
    if "franchise_kpi_records" not in _existing:
        op.create_table(
            ...
            sa.Column("kpi_month", sa.Date, nullable=False, comment="考核月份首日（用于范围查询）"),
