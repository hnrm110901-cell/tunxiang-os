...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("name", sa.VARCHAR(100), nullable=False, comment="报表名称"),
        ...
        sa.Column("data_source", sa.VARCHAR(50), nullable=True, comment="orders/members/inventory/employees/finance"),
        sa.Column(
            "dimensions",
        ...
        sa.Column("sort_by", sa.VARCHAR(50), nullable=True, comment="默认排序字段"),
        sa.Column("sort_order", sa.VARCHAR(4), nullable=False, server_default="desc"),
        sa.Column("chart_type", sa.VARCHAR(20), nullable=False, server_default="table", comment="table/bar/line/pie"),
        sa.Column("is_public", sa.Boolean(), nullable=False, server_default="false", comment="是否可分享"),
        sa.Column("share_token", sa.VARCHAR(64), nullable=True, unique=True, comment="分享token，is_public=true时生效"),
        sa.Column(
            "schedule_config",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=True,
    ...
    op.create_index(
        "idx_report_configs_share_token",
        "report_configs",
        ["share_token"],
    ...
    op.create_table(
        ...
        sa.Column("executed_by", postgresql.UUID(as_uuid=True), nullable=True, comment="NULL=定时触发"),
        sa.Column(
            "status", sa.VARCHAR(20), nullable=False, server_default="running", comment="running/completed/failed"
        ),
        sa.Column("row_count", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("execution_ms", sa.Integer(), nullable=True, comment="执行耗时"),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("tenant_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("name", sa.VARCHAR(100), nullable=False, comment='如"徐记海鲜活鲜专报"'),
        sa.Column("brand_focus", sa.VARCHAR(100), nullable=True, comment='核心关注点：如"活鲜销售/毛利"'),
        sa.Column("prompt_prefix", sa.TEXT(), nullable=True, comment="叙事生成前缀提示词"),
        sa.Column(
            "metrics_weights",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=True,
