...
def upgrade() -> None:
    ...
    if "dish_recipes" not in _existing:
        op.create_table(
            ...
            sa.Column("dish_id", UUID(as_uuid=True), nullable=False, comment="关联菜品ID（逻辑外键→dishes.id）"),
            sa.Column(
                "version", sa.Integer, nullable=False, server_default="1", comment="配方版本号，同菜品多版本共存"
            ),
            sa.Column("is_active", sa.Boolean, nullable=False, server_default="true", comment="是否激活版本"),
            sa.Column(
                "yield_qty",
                NUMERIC(10, 3),
                nullable=False,
            ...
            sa.Column("notes", sa.Text, nullable=True, comment="配方说明"),
    ...
    if "recipe_ingredients" not in _existing:
        op.create_table(
            ...
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
            sa.Column("recipe_id", UUID(as_uuid=True), nullable=False, comment="关联dish_recipes.id"),
            sa.Column("ingredient_name", sa.String(100), nullable=False, comment="原料名称"),
            sa.Column("ingredient_id", UUID(as_uuid=True), nullable=True, comment="可选关联原料库存表ID"),
            sa.Column(
                "qty",
                NUMERIC(10, 3),
                nullable=False,
            ...
            sa.Column("unit", sa.String(20), nullable=False, comment="单位：kg/g/ml/个/片"),
            sa.Column(
                "loss_rate",
                NUMERIC(5, 4),
                nullable=False,
    ...
    if "ck_production_plans" not in _existing:
        op.create_table(
            ...
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
            sa.Column("plan_date", sa.Date, nullable=False, comment="计划生产日期"),
            sa.Column(
                "status",
                sa.String(20),
                nullable=False,
            ...
            sa.Column("store_id", UUID(as_uuid=True), nullable=True, comment="为哪个门店生产（NULL=多门店）"),
    ...
    if "ck_plan_items" not in _existing:
        op.create_table(
            ...
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
            sa.Column("plan_id", UUID(as_uuid=True), nullable=False, comment="关联ck_production_plans.id"),
            sa.Column("dish_id", UUID(as_uuid=True), nullable=False, comment="菜品ID"),
            sa.Column("recipe_id", UUID(as_uuid=True), nullable=True, comment="关联dish_recipes.id（指定配方版本）"),
            sa.Column(
                "planned_qty",
                NUMERIC(10, 3),
                nullable=False,
            ...
            sa.Column("unit", sa.String(20), nullable=False, server_default="'portion'", comment="数量单位"),
            sa.Column(
                "status",
                sa.String(20),
                nullable=False,
    ...
    if "ck_dispatch_orders" not in _existing:
        op.create_table(
            ...
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
            sa.Column("dispatch_no", sa.String(50), nullable=False, comment="调拨单号（自动生成 CK-YYYYMMDD-XXXX）"),
            sa.Column("plan_id", UUID(as_uuid=True), nullable=True, comment="关联ck_production_plans.id"),
            sa.Column("from_store_id", UUID(as_uuid=True), nullable=True, comment="来源（中央厨房，NULL=总厂）"),
            sa.Column("to_store_id", UUID(as_uuid=True), nullable=False, comment="目标门店"),
            sa.Column("dispatch_date", sa.Date, nullable=False, comment="计划配送日期"),
            sa.Column(
                "status",
                sa.String(20),
                nullable=False,
            ...
            sa.Column("driver_name", sa.String(50), nullable=True, comment="司机姓名"),
            sa.Column("vehicle_no", sa.String(20), nullable=True, comment="车牌号"),
            sa.Column("receiver_name", sa.String(50), nullable=True, comment="收货人姓名"),
            sa.Column("received_at", sa.TIMESTAMP(timezone=True), nullable=True, comment="实际收货时间"),
            sa.Column("notes", sa.Text, nullable=True),
            sa.Column("created_at", sa.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=False),
            sa.Column("updated_at", sa.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=False),
            sa.Column("is_deleted", sa.Boolean, nullable=False, server_default="false"),
    ...
    if "ck_dispatch_items" not in _existing:
        op.create_table(
            ...
            sa.Column("tenant_id", UUID(as_uuid=True), nullable=False),
            sa.Column("dispatch_order_id", UUID(as_uuid=True), nullable=False, comment="关联ck_dispatch_orders.id"),
            sa.Column("dish_id", UUID(as_uuid=True), nullable=False, comment="菜品ID"),
            sa.Column(
                "planned_qty",
                NUMERIC(10, 3),
            ...
            sa.Column("unit", sa.String(20), nullable=False, comment="数量单位"),
            sa.Column("is_deleted", sa.Boolean, nullable=False, server_default="false"),
        )
