...
def upgrade() -> None:
    ...
    op.create_index("ix_dish_recipes_tenant_dish", "dish_recipes", ["tenant_id", "dish_id"])
    op.create_index("ix_dish_recipes_dish_id", "dish_recipes", ["dish_id"])
    op.create_unique_constraint(
        "uq_dish_recipes_dish_version", "dish_recipes", ["tenant_id", "dish_id", "version"]
    )
    ...
    op.create_index("ix_recipe_ingredients_tenant_recipe",
                    "recipe_ingredients", ["tenant_id", "recipe_id"])
    ...
    op.create_index("ix_ck_production_plans_tenant_date",
                    "ck_production_plans", ["tenant_id", "plan_date"])
    op.create_index("ix_ck_production_plans_status",
                    "ck_production_plans", ["status"])
    ...
    op.create_index("ix_ck_plan_items_plan_id", "ck_plan_items", ["plan_id"])
    op.create_index("ix_ck_plan_items_dish_id", "ck_plan_items", ["dish_id"])
    op.create_index("ix_ck_plan_items_tenant_plan", "ck_plan_items", ["tenant_id", "plan_id"])
    ...
    op.create_unique_constraint(
        "uq_ck_dispatch_orders_no", "ck_dispatch_orders", ["tenant_id", "dispatch_no"]
    )
    op.create_index("ix_ck_dispatch_orders_to_store_date",
                    "ck_dispatch_orders", ["to_store_id", "dispatch_date"])
    op.create_index("ix_ck_dispatch_orders_tenant_date",
                    "ck_dispatch_orders", ["tenant_id", "dispatch_date"])
    op.create_index("ix_ck_dispatch_orders_status",
                    "ck_dispatch_orders", ["status"])
    ...
    op.create_index("ix_ck_dispatch_items_order_id",
                    "ck_dispatch_items", ["dispatch_order_id"])
    op.create_index("ix_ck_dispatch_items_tenant_order",
                    "ck_dispatch_items", ["tenant_id", "dispatch_order_id"])
