...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.String(20), nullable=False, server_default="draft", comment="draft|active|paused|ended"),
        # 邀请方奖励
        sa.Column(
        ...
        sa.Column(
            "referrer_reward_value", sa.Integer(), nullable=False, server_default="0", comment="优惠券ID/积分数/储值分"
        ),
        sa.Column(
            "referrer_reward_condition",
            sa.String(20),
            nullable=False,
        ...
        sa.Column(
            "min_order_amount_fen",
            sa.Integer(),
            nullable=False,
            server_default="0",
            comment="新人首单最低金额(分)，0=不限",
        ),
        sa.Column("valid_days", sa.Integer(), nullable=False, server_default="30", comment="邀请链接有效天数"),
        # 防刷开关
    ...
    op.create_table(
        ...
        # 邀请码
        sa.Column("invite_code", sa.String(16), nullable=False, unique=True, comment="唯一邀请码（8位大写字母数字）"),
