...
def upgrade() -> None:
    ...
    _cond_dc = "current_setting('app.tenant_id', TRUE) IS NOT NULL AND current_setting('app.tenant_id', TRUE) <> '' AND tenant_id = NULLIF(current_setting('app.tenant_id', TRUE), '')::UUID"
    ...
    _cond_spc = "current_setting('app.tenant_id', TRUE) IS NOT NULL AND current_setting('app.tenant_id', TRUE) <> '' AND tenant_id = NULLIF(current_setting('app.tenant_id', TRUE), '')::UUID"
    for action in ("SELECT", "INSERT", "UPDATE", "DELETE"):
    ...
    _cond_bpt = "current_setting('app.tenant_id', TRUE) IS NOT NULL AND current_setting('app.tenant_id', TRUE) <> '' AND tenant_id = NULLIF(current_setting('app.tenant_id', TRUE), '')::UUID"
    for action in ("SELECT", "INSERT", "UPDATE", "DELETE"):
    ...
    _cond_it = "current_setting('app.tenant_id', TRUE) IS NOT NULL AND current_setting('app.tenant_id', TRUE) <> '' AND tenant_id = NULLIF(current_setting('app.tenant_id', TRUE), '')::UUID"
    for action in ("SELECT", "INSERT", "UPDATE", "DELETE"):
