...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("store_id", postgresql.UUID(as_uuid=True), nullable=False, comment="哪个门店的覆盖"),
        sa.Column("dish_id", postgresql.UUID(as_uuid=True), nullable=False, comment="哪道菜"),
        sa.Column(
            "channel", sa.VARCHAR(30), nullable=False, comment="dine_in/takeaway/meituan/eleme/douyin/miniapp/all"
        ),
        sa.Column("price_fen", sa.BIGINT(), nullable=True, comment="覆盖价格（分），NULL=使用品牌标准价"),
        sa.Column(
            "is_available", sa.Boolean(), nullable=False, server_default="true", comment="是否在该渠道该门店可见"
        ),
        sa.Column("available_from", sa.TIME(), nullable=True, comment="时段限制：起始时间，NULL=全天"),
        sa.Column("available_until", sa.TIME(), nullable=True, comment="时段限制：结束时间"),
        sa.Column(
            "override_reason", sa.VARCHAR(100), nullable=True, comment="覆盖原因：regional_price/stock/promotion"
        ),
        sa.Column("approved_by", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column("effective_date", sa.DATE(), nullable=True),
        sa.Column("expires_date", sa.DATE(), nullable=True, comment="NULL=永久有效"),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("tenant_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("card_no", sa.VARCHAR(30), nullable=False, unique=True, comment="卡号：PMC-YYYYMM-XXXX"),
        ...
        sa.Column("price_fen", sa.BIGINT(), nullable=False, comment="购买价格（分）"),
        sa.Column("start_date", sa.DATE(), nullable=False),
        sa.Column("end_date", sa.DATE(), nullable=True, comment="终身卡为NULL"),
        sa.Column(
            "status",
            sa.VARCHAR(20),
            nullable=False,
        ...
        sa.Column("purchase_channel", sa.VARCHAR(30), nullable=True, comment="miniapp/pos/wecom"),
