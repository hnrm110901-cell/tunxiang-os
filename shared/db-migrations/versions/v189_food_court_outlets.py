...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('name', sa.VARCHAR(100), nullable=False,
                  comment='档口名称，如"张记烤鱼"'),
        sa.Column('outlet_code', sa.VARCHAR(20), nullable=True,
                  comment='档口编号，如A01/B02'),
        sa.Column('location', sa.VARCHAR(100), nullable=True,
                  comment='区位描述，如"A区1号"'),
        sa.Column('owner_name', sa.VARCHAR(50), nullable=True,
                  comment='档口负责人姓名'),
        sa.Column('owner_phone', sa.VARCHAR(20), nullable=True,
                  comment='档口负责人电话'),
    ...
    op.create_table(
        ...
        sa.Column('order_id', postgresql.UUID(as_uuid=True), nullable=False,
                  comment='关联主订单'),
        sa.Column('subtotal_fen', sa.BIGINT(), nullable=False,
                  server_default='0',
                  comment='该档口小计，单位：分'),
