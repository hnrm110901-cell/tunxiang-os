...
export type Locale = 'zh-CN' | 'en-US' | 'ja-JP' | 'id-ID' | 'vi-VN'
...
const messages: Record<Locale, Record<string, string>> = {
  ...
  'vi-VN': {
    ...
    'home.hot_dishes': 'Món Bán Chạy',
    'home.ai_recommend': 'AI Gợi Ý Cho Bạn',
    'home.activities': 'Khuyến Mãi Hôm Nay',
    'home.reorder': 'Đặt Lại',
    'menu.search': 'Tìm Món',
    'menu.all': 'Tất Cả',
    'menu.sold_out': 'Hết Hàng',
    'menu.add_to_cart': 'Thêm Vào Giỏ',
    'menu.specs': 'Chọn Quy Cách',
    'cart.title': 'Giỏ Hàng',
    ...
    'member.level': 'Cấp Thành Viên',
    'member.points': 'Điểm',
    'member.stored_value': 'Số Dư',
    'member.subscription': 'Đăng Ký',
    'member.taste_profile': 'Hồ Sơ Khẩu Vị',
    'member.cross_brand': 'Quyền Lợi Đa Thương Hiệu',
    'member.insights': 'Báo Cáo Tiêu Dùng',
    'queue.take_number': 'Lấy Số Chờ',
    'queue.position': 'Đang chờ trước',
    'queue.tables': 'bàn',
    'queue.estimated_wait': 'Dự kiến',
    'queue.minutes': 'phút',
    'preorder.title': 'Đặt Trước',
    'preorder.select_store': 'Chọn Cửa Hàng',
    'preorder.select_time': 'Chọn Thời Gian',
    'preorder.confirm': 'Xác Nhận',
    'preorder.start_order': 'Bắt Đầu Gọi Món',
    'ai.assistant': 'Trợ Lý AI',
    'ai.thinking': 'AI đang suy nghĩ...',
    'ai.add': '+ Thêm',
    'ai.allergen_warning': 'Cảnh Báo Dị Ứng',
  },
  'id-ID': {
    ...
    'home.hot_dishes': 'Menu Populer',
    'home.ai_recommend': 'Rekomendasi AI',
    'home.activities': 'Promo Hari Ini',
    'home.reorder': 'Pesan Lagi',
    'menu.search': 'Cari Menu',
    'menu.all': 'Semua',
    'menu.sold_out': 'Habis',
    'menu.add_to_cart': 'Tambah ke Keranjang',
    'menu.specs': 'Pilih Spesifikasi',
    'cart.title': 'Keranjang',
    'cart.empty': 'Keranjang kosong',
    'cart.checkout': 'Pembayaran',
    'cart.total': 'Total',
    'order.all': 'Semua',
    'order.pending': 'Belum Bayar',
    'order.processing': 'Diproses',
    'order.completed': 'Selesai',
    'order.empty': 'Belum Ada Pesanan',
    'member.level': 'Tingkat Anggota',
    'member.points': 'Poin',
    'member.stored_value': 'Saldo',
    'member.subscription': 'Langganan',
    'member.taste_profile': 'Profil Rasa',
    'member.cross_brand': 'Lintas Merek',
    'member.insights': 'Laporan Saya',
    'queue.take_number': 'Ambil Antrean',
    'queue.position': 'Di Depan Anda',
    'queue.tables': 'meja',
    'queue.estimated_wait': 'Estimasi',
    'queue.minutes': 'menit',
    'preorder.title': 'Pre-Pesan',
    'preorder.select_store': 'Pilih Toko',
    'preorder.select_time': 'Pilih Waktu',
    'preorder.confirm': 'Konfirmasi Detail',
    'preorder.start_order': 'Mulai Pesan',
    'ai.assistant': 'Asisten AI',
    'ai.thinking': 'AI sedang berpikir...',
    'ai.add': '+ Tambah',
    'ai.allergen_warning': 'Peringatan Alergen',
  },
}
...
export function initLocale(): void {
  ...
  if (stored && stored in messages) {
    ...
    else if (lang.startsWith('vi')) currentLocale = 'vi-VN'
    else if (lang.startsWith('id')) currentLocale = 'id-ID'
...
export const SUPPORTED_LOCALES: { locale: Locale; label: string; flag: string }[] = [
  ...
  { locale: 'vi-VN', label: 'Tiếng Việt', flag: '🇻🇳' },
  { locale: 'id-ID', label: 'Bahasa Indonesia', flag: '🇮🇩' },
]
