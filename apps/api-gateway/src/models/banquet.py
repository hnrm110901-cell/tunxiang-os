...
class BanquetHall(Base, TimestampMixin):
    ...
    __table_args__ = (
        Index("ix_banquet_halls_store_active", "store_id", "is_active"),
    )
...
class BanquetCustomer(Base, TimestampMixin):
    ...
    __table_args__ = (
        Index("ix_banquet_customers_brand_phone", "brand_id", "phone"),
    )
...
class BanquetKpiDaily(Base, TimestampMixin):
    ...
    __table_args__ = (
        UniqueConstraint("store_id", "stat_date", name="uq_banquet_kpi_store_date"),
    )
