...
from sqlalchemy import (
    ...
    ForeignKey, Enum as SAEnum, JSON, Index, UniqueConstraint, Numeric,
)
...
class Dish(Base):
    ...
    __table_args__ = (
        Index("ix_dish_rd_dishes_brand_status", "brand_id", "status"),
    )
...
class DishFeedback(Base):
    ...
    __table_args__ = (
        Index("ix_dish_rd_feedbacks_dish_type", "dish_id", "feedback_type"),
    )
