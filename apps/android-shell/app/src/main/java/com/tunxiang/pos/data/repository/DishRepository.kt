...
import com.tunxiang.pos.data.remote.DishResponse
import com.tunxiang.pos.data.remote.TxCoreApi
import com.tunxiang.pos.sync.SyncManager
import kotlinx.coroutines.flow.Flow

/**
 * DishRepository - Full cache + 15-minute incremental sync.
 *
 * Strategy:
 * - On startup: full pull if cache is empty, else incremental
 * - Periodic: incremental (updated_after = last sync timestamp)
...
private fun DishResponse.toLocal(storeId: String): LocalDishCache {
