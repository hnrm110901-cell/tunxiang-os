...
const s = {
  ...
  faqQuestion: (isOpen: boolean) => ({
    ...
    color: isOpen ? txColors.primary : '#E0E0E0', transition: 'color 0.2s',
  ...
  docModule: {
    ...
    fontSize: 11, fontWeight: 600, background: `${txColors.primary}22`, color: txColors.primary, marginBottom: 6,
  } as React.CSSProperties,
  ...
  btn: {
    background: txColors.primary, color: '#FFF', border: 'none', borderRadius: 8,
    padding: '12px 28px', fontSize: 14, fontWeight: 600, cursor: 'pointer',
  } as React.CSSProperties,
  btnOutline: {
    background: 'transparent', color: txColors.primary, border: `1px solid ${txColors.primary}`, borderRadius: 8,
    padding: '12px 28px', fontSize: 14, fontWeight: 600, cursor: 'pointer',
  } as React.CSSProperties,
  ...
  videoThumb: {
    ...
    fontSize: 36, color: txColors.primary, position: 'relative' as const,
  } as React.CSSProperties,
  videoDuration: {
  ...
  modalPlayer: {
    ...
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    fontSize: 48, color: txColors.primary, marginBottom: 16,
  } as React.CSSProperties,
  modalClose: {
        ...
        <div style={s.videoGrid}>
          {VIDEO_LIST.map((video) => (
            <div
              ...
              tabIndex={0}
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLDivElement).style.borderColor = txColors.primary;
              }}
              onMouseLeave={(e) => {
