...
const PEAK_CONFIG: Record<PeakLevel, { label: string; color: string; bg: string; desc: string }> = {
  normal:  { label: '正常',    color: txColors.success, bg: `${txColors.success}30`, desc: '客流平稳，各档口运转正常' },
  busy:    { label: '繁忙',    color: txColors.warning, bg: `${txColors.warning}30`, desc: '客流上升，部分档口压力较大' },
  peak:    { label: '高峰',    color: txColors.primary, bg: `${txColors.primary}30`, desc: '高峰时段，需要加派人手' },
  extreme: { label: '极端高峰', color: txColors.danger, bg: `${txColors.danger}30`, desc: '客流爆满，启动应急预案' },
};

// ---------- 工具函数 ----------
const loadPercent = (s: StallLoad) => Math.round((s.currentOrders / s.capacity) * 100);
const loadColor = (pct: number) => pct >= 90 ? txColors.danger : pct >= 70 ? txColors.warning : txColors.success;
const urgencyColor = (u: string) => u === 'critical' ? txColors.danger : u === 'urgent' ? txColors.warning : txColors.info;
    ...
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <span style={{
            width: 8, height: 8, borderRadius: '50%', background: loading ? txColors.warning : txColors.success,
      ...
      <div style={{
        ...
        {level === 'extreme' && (
          <div style={{
            padding: '8px 20px', background: txColors.danger, borderRadius: 8,
          ...
          {peakData.waiting.length === 0 ? (
            ...
            <>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                {peakData.waiting.map((w) => (
                  <div key={w.type} style={{
                    ...
                    borderLeft: `3px solid ${w.estimateMin > 30 ? txColors.danger : w.estimateMin > 15 ? txColors.warning : txColors.success}`,
                  }}>
                    <div>
                    ...
                    <div style={{ textAlign: 'center' }}>
                      <div style={{
                        ...
                        color: w.count >= 5 ? txColors.danger : w.count >= 3 ? txColors.warning : '#fff',
                      }}>
                        {w.count}
                      </div>
              ...
              <div style={{
                ...
                background: `${txColors.primary}15`, border: `1px solid ${txColors.primary}40`,
                fontSize: 13, color: txColors.primary, textAlign: 'center',
              }}>
              ...
              <div key={s.id} style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 12, color: '#999', marginTop: 4 }}>
                    建议加派: <span style={{ color: txColors.primary }}>{s.suggestedStaff}</span>
                  </div>
                </div>
                <button style={{
      ...
      <div style={{ background: '#112228', borderRadius: 8, padding: 20 }}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <button
            ...
            style={{
              padding: '10px 24px', borderRadius: 8, border: `1px solid ${txColors.warning}`,
              background: `${txColors.warning}20`, color: txColors.warning, cursor: 'pointer',
          ...
          <button
            ...
            style={{
              padding: '10px 24px', borderRadius: 8, border: `1px solid ${txColors.info}`,
              background: `${txColors.info}20`, color: txColors.info, cursor: 'pointer',
              fontWeight: 600, fontSize: 13,
            }}
          >
            调台优化
          ...
          <button
            ...
            style={{
              ...
              background: quickMode ? txColors.danger : txColors.primary,
          ...
          <button
            ...
            style={{
              padding: '10px 24px', borderRadius: 8, border: `1px solid ${txColors.success}`,
              background: `${txColors.success}20`, color: txColors.success, cursor: 'pointer',
              fontWeight: 600, fontSize: 13,
            }}
          >
            一键通知全员
        ...
        {quickMode && (
          <div style={{
            marginTop: 12, padding: 10, borderRadius: 8,
            background: `${txColors.danger}20`, border: `1px solid ${txColors.danger}`,
            fontSize: 13, color: txColors.danger,
          }}>
