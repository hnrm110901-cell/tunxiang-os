  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius: 16,
        padding: '48px 40px',
        boxShadow: '0 4px 40px rgba(0,0,0,0.4), 0 0 0 1px rgba(255,255,255,0.05)',
        position: 'relative',
        zIndex: 1,
      }}>
        {/* Logo */}
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            <input
              ...
              onFocus={(e) => e.currentTarget.style.borderColor = 'rgba(255,107,44,0.5)'}
