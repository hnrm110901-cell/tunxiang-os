...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { name: '电子签约', desc: '模板/信封/印章/审计链', icon: '✍️', to: '/e-signature/envelopes', isNew: true },
      { name: '法人主体', desc: '直营/加盟/合资多主体', icon: '🏢', to: '/legal-entities', isNew: true },
      { name: '九宫格人才盘点', desc: '业绩×潜力二维矩阵', icon: '🎯', to: '/hr/talent/nine-box', isNew: true },
      { name: 'HR 助手', desc: '数字人|自然语言查 HR 数据', icon: '🤖', to: '/hr/assistant', isNew: true },
      { name: 'OKR 目标', desc: '目标树+KR打卡+健康分', icon: '🎯', to: '/hr/okr', isNew: true },
      { name: '学习地图', desc: '岗位学习路径/前置课程', icon: '🗺️', to: '/hr/learning/map', isNew: true },
      { name: '学习积分榜', desc: '积分/徽章/排行', icon: '🏆', to: '/hr/learning/leaderboard', isNew: true },
      { name: '脉搏调研', desc: '匿名问卷/情感趋势', icon: '💓', to: '/hr/pulse', isNew: true },
    ],
  },
  {
    title: '报表与决策',
